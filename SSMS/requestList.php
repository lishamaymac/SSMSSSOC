...
<tr class="labels" style="font-size:14px;"><td style="text-align: center;"><?php echo $y['name'];?></td><td style="text-align: center;"><?php echo $y['quantity'];?></td>
<td style="text-align: center;"><?php echo $y['date'];?></td><td style="text-align: center;"><?php echo $y['status'];?></td><td style="text-align: center;"><?php echo $y['remark'];?></td>
</tr>
<?php
}
?>

...
<table border="0" class="table" cellpadding="5" cellspacing="6">
	...
	<td style="text-align: center;">Available Stock</td>
	...
	while($pr = mysqli_fetch_array($sql2))
	{
		?>
			<tr>
				<td class="labels center"><?php echo $sr++;?></td>
				<td class="labels center"><?php echo $pr['item_code'];?></td>
				<td class="labels center" style="text-align: center;"><?php echo $pr['name'];?></td>
				<td class="labels center" style="text-align: center;"><?php echo $pr['quantity'];?></td>
				<td>
